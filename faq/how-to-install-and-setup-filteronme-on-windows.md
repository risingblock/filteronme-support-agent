...
1. Download the installer from [filteronme.com/downloads](https://filteronme.com/downloads).
2. Run the .msi file.
...
- 8GB RAM or more
- ~3.8GHz i3 processor or better

Not sure your machine qualifies? The free trial is the fastest way to check.
...
Installer won't finish, or throwing an error? Our [Windows installer troubleshooting guide](https://help.filteronme.com/article/106-there-is-a-problem-with-this-windows-installer-package) covers it.
