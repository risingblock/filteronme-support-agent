...
- **Portal access problems get the login-link workaround, not an immediate manual cancel:** try another email, or use the billing-email lookup at https://filteronme.com/billing-email (doc 108).
